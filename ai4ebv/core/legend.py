...
# copy class legen labels from lancover.py which ever need to be used for example corine or LISS.
# then in sample.py replace the label for water and snow as in the working legend
